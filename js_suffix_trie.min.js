...
this.findNode(a);return a!==null&&a.terminator};d.prototype.subTrie=function(a){var b;a=this.findNode(a);b=new d;b.structure=a;return b};d.prototype.find=function(a){return d.toArray(this.findNode(a),"")};d.prototype.findNode=function(a){var b,c,f,e;e=this.structure;f=a.length;for(c=0;c<f;){b=a[c++];e=e[b];if(!e)return null}return e};d.prototype.each=function(a){return d.each(a,this.structure,0,"")};d.each=function(a,b,c,f){var e;b.terminator&&a(c++,f);for(e in b)c=this.each(a,b[e],c,f+e);return c};
d.prototype.size=function(){return this.count};d.prototype.calculateSize=function(a){var b,c;if(a==null)a=this.structure;c=a.terminator?1:0;for(b in a)c+=this.calculateSize(a[b]);return c};d.fromArray=function(a){var b,c,f;f=new d;c=a.length;for(b=0;b<c;)f.add(a[b++]);f.count=b;return f};d.prototype.toArray=function(){return d.toArray(this.structure,"")};d.toArray=function(a,b){var c;c=[];this.each(function(f,e){return c[f]=e},a,0,b);return c};d.fromJSON=function(a){var b;b=new d;b.structure=JSON.parse(a);
b.calculateSize();return b};d.prototype.toJSON=function(){return JSON.stringify(this.structure)};return d}();
